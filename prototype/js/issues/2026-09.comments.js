/* ============================================================================
   TOHUM YORUMLAR · Sayı 03 "Kızıl Mevsim"
   ----------------------------------------------------------------------------
   İçerik ile yorum bilerek ayrı dosyada: gerçek üründe biri `packages/content`
   derleyicisinden gelir, öteki veritabanından. issues/2026-09.js derleyici
   çıktısıdır, bu dosya ise sosyal katman.
   ...
   veri "birkaç örnek" değil, dolu bir sayı: ~250 yorum, gerçek hayattaki gibi
   ...
   Kurucular (on / pin / loose) ve okur kadrosu js/data-comments.js'te; burası
   yalnızca bu sayının tohumunu döşer.
   ========================================================================= */

(function (MAG) {
  "use strict";

  (MAG.issueComments = MAG.issueComments || {})["2026-09"] = function (K) {
    var on = K.on;
    var pin = K.pin;
    var loose = K.loose;
