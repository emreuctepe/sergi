...
export default defineConfig(
	...
	{
		/* Lint'in dokunmadığı alanlar.
		   - prototype/: donmuş referans. Derlemesiz, `window.MAG` IIFE düzeninde,
		     bilinçli olarak ES modülsüz yazıldı (bkz. docs/MIMARI.md). Modern
